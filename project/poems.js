// Poem data — text, motif, and position on the garden canvas (0..1 coords).
// Order defines the golden thread path.
window.POEMS = [
  {
    id: "the-exile",
    title: "The Exile",
    motif: "lotus",
    image: "images/the-exile.jpeg",
    x: 0.3, y: 0.04,
    palette: { wash: "#eef6f5", ink: "#244a4a" },
    epigraph: "Lovingly nudged, I followed the golden thread…",
    body: `Long, I wandered, exiled from my Lord's table.
...
Home, at last, an exile no more.`
  ...
  {
    id: "since-the-beginning",
    title: "Since the Beginning",
    motif: "morning-star",
    image: "images/since-the-beginning.jpeg",
    x: 0.7, y: 0.11,
    palette: { wash: "#fff6e0", ink: "#6b4a1a" },
    epigraph: "I waited since the beginning for you…",
    body: `I waited since the beginning for you,
From speaking light into being,
I counted down every second until
I could tell you how loved you are!

I know every hair on your head,
My breath is in every cell of yours.
I have never regretted making you
And to the end of time, I never will.

Every one of my beloved prophets spoke
So that you would open your eyes to me
And lift up your voice in my chorus.
You were made with a song to sing to me.

I sing in every blade of grass and whisper
In the wind of the hills and dales.
I cry out in the song of the morning lark
And laugh in the gurgling of streams.

I am Alpha and Omega, beginning and end.
Morning Star and the dark shade of evening
My being is the being in all things.
I hide in plain sight behind every door.

Knock for Me and I shall always answer.
Cry out in the silence of the night
And I will listen to every word you utter.
Ask in My name, for I delight in gifts.

Treasure what I love in your heart
And you will reap hundredfold what you sow.
Join my dance, the song of the harvest,
And New Eden will throng with thanksgiving.

Every soul a flower all adding sweet scent
And lending the hue of their petals
To a timeless dance under my breath.
Every one treasured since the beginning.`
  },
  {
    id: "imago-dei",
    title: "Imago Dei",
    motif: "vesica",
    image: "images/imago-dei.jpeg",
    x: 0.32, y: 0.182,
    palette: { wash: "#f3f7ee", ink: "#3d5a2a" },
    epigraph: "Made above, to steward all creatures…",
    body: `Made above, to steward all creatures,
...
by grace, our new bodies will go where the Son went.`
  },
  {
    ...
    motif: "dove",
    image: "images/for-love-in-love.jpeg",
    x: 0.72, y: 0.253,
    palette: { wash: "#f3ecff", ink: "#4a3a7a" },
    epigraph: "Fearfully and wonderfully made you are.",
    body: `For love, in love, He made you.
...
glorifying God in all they do.`
  },
  {
    ...
    motif: "sword-shield",
    image: "images/radiant-knight.jpeg",
    x: 0.3, y: 0.324,
    palette: { wash: "#eef1f6", ink: "#2a3a5a" },
    epigraph: "Ready to humbly serve, your radiant knight…",
    body: `Praise be to you, Eternal Light,
...
so they might see You in me too.`
  },
  {
    ...
    motif: "olive",
    image: "images/my-peace.jpeg",
    x: 0.7, y: 0.395,
    palette: { wash: "#eff5ec", ink: "#3a4a24" },
    epigraph: "Deepest Shalom, beyond earthly knowing.",
    body: `My peace I give to you, peace be with you!
Deepest Shalom, beyond earthly knowing.

In grass, sunlight and birdsong, a Paschal view.
My yoke is easy, my burden light, overflowing.

Knock and I shall answer, seek and find!
Keep My commandments, abide and simply be.

Follow Me, become fishers of another kind,
you will have treasure in heaven: now, follow Me.

One family, under My Father eternal, be My bride,
know My love for you, from before you were born.

Make your burdens mine, in Me you can confide,
Come to My Father boldly, the curtain is torn.`
  },
  {
    id: "pour-out",
    title: "Pour Out My Soul",
    motif: "chalice-incense",
    image: "images/pour-out.jpeg",
    x: 0.32, y: 0.466,
    palette: { wash: "#f6ede0", ink: "#5a3a14" },
    epigraph: "Hands of praise held above, fill gold bowls with incense.",
    body: `I pour out my soul to you, Lord,
...
it sweetens all I do.`
  ...
  {
    id: "all-of-my-creatures",
    title: "All of My Creatures",
    motif: "lamb",
    image: "images/all-of-my-creatures.jpeg",
    x: 0.72, y: 0.537,
    palette: { wash: "#f1eee6", ink: "#443a2a" },
    epigraph: "All of my creatures have my breath…",
    body: `All of my creatures have my breath,
...
come to God's Lamb and adore.`
  },
  {
    ...
    motif: "seven-petal",
    image: "images/sweet-sophia.jpeg",
    x: 0.3, y: 0.608,
    palette: { wash: "#f6eef4", ink: "#5a2a55" },
    epigraph: "Seven pillars, facets of the Spirit seven…",
    body: `Sweet Sophia, Holy Hokhmah, Wisdom of old,
...
In eternal love, a garden of many flowers.`
  },
  {
    ...
    title: "A Name Untold",
    motif: "oak",
    image: "images/a-name-untold.jpeg",
    x: 0.7, y: 0.679,
    palette: { wash: "#f4efe2", ink: "#4a3820" },
    epigraph: "I am given my name, the Oaken Pilgrim.",
    body: `Long I've wandered, seeking a name unknown,
...
I've rested in the depths, where light stops.
Wearing many guises, no fixed costume,
Travailing the soul's castle, known in every room.

Something yet escapes my hold,
To know my true kind, a name untold.
What word could compass both light and dark,
Earth and sky, and marry contrasts stark?

Chthonic depths and airy heights,
Where reason grounds and vision flights.
Abstract yet embodied, rooted but upright,
A righteous oak, humbled might.

Branches like leafy tusks give shade,
Not alone, but one among the green glade.
A rooted wanderer, eyes on heaven's brim,
I am given my name, the Oaken Pilgrim.`
  },
  {
    id: "even-ground",
    title: "Even Ground",
    motif: "skylark",
    image: "images/even-ground.jpeg",
    x: 0.32, y: 0.75,
    palette: { wash: "#eef4ee", ink: "#2c4a34" },
    epigraph: "Like a skylark I am carried on winds of the heart…",
    body: `I've walked on sunlit mountain tops,
slept in misty depths where sunlight stops.

Yet the place where I thrive is even ground,
An age ago, I never knew the peace I've found.

Euthymia, I now inhabit, a stabler mood,
In a peaceful present moment I brood.

Still, my heart rides with the seasons,
with no soar and crash, just gentle easings.

The cool of winter, a time of rooting depth,
and sunlit warmth, the season of creative weft.

Like a skylark I am carried on winds of the heart,
over a meandering landscape, peace to impart.`
  },
  {
    id: "rose-bower",
    title: "The Rose Bower",
    motif: "rose",
    image: "images/rose-bower.jpeg",
    x: 0.72, y: 0.821,
    palette: { wash: "#f8ecec", ink: "#6a2030" },
    epigraph: "I have a rose bower where the flowers always bloom.",
    body: `I have a rose bower
...
The sweet scent calls me home.`
  },
  {
    ...
    title: "Communion",
    motif: "chalice",
    image: "images/communion.jpeg",
    x: 0.5, y: 0.91,
    palette: { wash: "#f7eedf", ink: "#6a3a1a" },
    epigraph: "An exile no more, communion calls me home, by a golden thread.",
    body: `Meet me at the table, my Lord,
